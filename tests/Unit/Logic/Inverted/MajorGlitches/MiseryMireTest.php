...
final class MiseryMireTest extends TestCase
{
    ...
    public function accessPool(): array
    {
        return [
            ...
            ["Misery Mire - Main Lobby Chest", true, ['KeyD6', 'Hookshot', 'Ether', 'UncleSword']],
            ["Misery Mire - Main Lobby Chest", true, ['KeyD6', 'Hookshot', 'Ether', 'ProgressiveSword']],
            ["Misery Mire - Main Lobby Chest", true, ['KeyD6', 'Hookshot', 'Ether', 'MasterSword']],
            ["Misery Mire - Main Lobby Chest", true, ['KeyD6', 'Hookshot', 'Ether', 'L3Sword']],
            ["Misery Mire - Main Lobby Chest", true, ['KeyD6', 'Hookshot', 'Ether', 'L4Sword']],
