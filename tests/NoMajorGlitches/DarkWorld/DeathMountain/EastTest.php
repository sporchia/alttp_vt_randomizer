...
class EastTest extends TestCase {
	...
	public function accessPool() {
		return [
			...
			["[cave-057-1F] Dark World Death Mountain - cave from top to bottom [top chest]", false, [], ['Gloves']],
			["[cave-057-1F] Dark World Death Mountain - cave from top to bottom [top chest]", false, [], ['MoonPearl']],
			...
			["[cave-057-1F] Dark World Death Mountain - cave from top to bottom [bottom chest]", false, [], ['Gloves']],
			["[cave-057-1F] Dark World Death Mountain - cave from top to bottom [bottom chest]", false, [], ['MoonPearl']],
