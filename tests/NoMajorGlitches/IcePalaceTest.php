...
class IcePalaceTest extends TestCase {
	...
	public function testCanEnterWithEverything() {
		$this->assertTrue($this->world->getRegion('Ice Palace')->canEnter($this->world->getLocations(), $this->allItems()));
	}

	public function testMoonPearlRequiredForEntry() {
		$this->assertFalse($this->world->getRegion('Ice Palace')->canEnter($this->world->getLocations(), $this->allItemsExcept(['MoonPearl'])));
	}

	public function testFlippersRequiredForEntry() {
		$this->assertFalse($this->world->getRegion('Ice Palace')->canEnter($this->world->getLocations(), $this->allItemsExcept(['Flippers'])));
	}

	public function testMittRequiredForEntry() {
		$this->assertFalse($this->world->getRegion('Ice Palace')->canEnter($this->world->getLocations(), $this->allItemsExcept(['TitansMitt'])));
	}

	public function testMeltingRequiredForEntry() {
		$this->assertFalse($this->world->getRegion('Ice Palace')->canEnter($this->world->getLocations(), $this->allItemsExcept(['FireRod', 'Bombos'])));
	}

	public function testNotOnlyFireRodRequiredForEntry() {
		$this->assertTrue($this->world->getRegion('Ice Palace')->canEnter($this->world->getLocations(), $this->allItemsExcept(['FireRod'])));
	}

	public function testNotOnlyBombosRequiredForEntry() {
		$this->assertTrue($this->world->getRegion('Ice Palace')->canEnter($this->world->getLocations(), $this->allItemsExcept(['Bombos'])));
	}
	...
	public function testKholdstareCantHaveBigKey() {
		$this->assertFalse($this->world->getLocation("Heart Container - Kholdstare")->fill(Item::get('BigKey'), $this->allItems()));
	}
