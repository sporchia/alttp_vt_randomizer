...
class SkullWoodsTest extends TestCase {
	...
	public function accessPool() {
		return [
			...
			["Heart Container - Mothula", true, ['MoonPearl', 'TitansMitt', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'TitansMitt', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'TitansMitt', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'TitansMitt', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'TitansMitt', 'FireRod', 'ProgressiveSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'ProgressiveGlove', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'ProgressiveGlove', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'ProgressiveGlove', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'ProgressiveGlove', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'ProgressiveGlove', 'FireRod', 'ProgressiveSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'Hammer', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'Hammer', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'Hammer', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'Hammer', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'ProgressiveGlove', 'Hammer', 'FireRod', 'ProgressiveSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'PowerGlove', 'Hammer', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'PowerGlove', 'Hammer', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'PowerGlove', 'Hammer', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'PowerGlove', 'Hammer', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'PowerGlove', 'Hammer', 'FireRod', 'ProgressiveSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Hammer', 'Hookshot', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Hammer', 'Hookshot', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Hammer', 'Hookshot', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Hammer', 'Hookshot', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Hammer', 'Hookshot', 'FireRod', 'ProgressiveSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'ProgressiveGlove', 'Hookshot', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'ProgressiveGlove', 'Hookshot', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'ProgressiveGlove', 'Hookshot', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'ProgressiveGlove', 'Hookshot', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'ProgressiveGlove', 'Hookshot', 'FireRod', 'ProgressiveSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'PowerGlove', 'Hookshot', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'PowerGlove', 'Hookshot', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'PowerGlove', 'Hookshot', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'PowerGlove', 'Hookshot', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'PowerGlove', 'Hookshot', 'FireRod', 'ProgressiveSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Flippers', 'Hookshot', 'FireRod', 'L1Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Flippers', 'Hookshot', 'FireRod', 'MasterSword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Flippers', 'Hookshot', 'FireRod', 'L3Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Flippers', 'Hookshot', 'FireRod', 'L4Sword']],
			["Heart Container - Mothula", true, ['MoonPearl', 'DefeatAgahnim', 'Flippers', 'Hookshot', 'FireRod', 'ProgressiveSword']],
		];
	}
}
