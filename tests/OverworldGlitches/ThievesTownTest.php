...
class ThievesTownTest extends TestCase {
	...
	public function accessPool() {
		return [
			...
			["Thieves' Town - Boss", true, ['KeyD4', 'MoonPearl', 'TitansMitt', 'BigKeyD4', 'L1Sword']],
			...
			["Thieves' Town - Boss", true, ['KeyD4', 'MoonPearl', 'ProgressiveGlove', 'ProgressiveGlove', 'BigKeyD4', 'L1Sword']],
			...
			["Thieves' Town - Boss", true, ['KeyD4', 'MoonPearl', 'DefeatAgahnim', 'ProgressiveGlove', 'Hookshot', 'BigKeyD4', 'L1Sword']],
			...
			["Thieves' Town - Boss", true, ['KeyD4', 'MoonPearl', 'DefeatAgahnim', 'PowerGlove', 'Hookshot', 'BigKeyD4', 'L1Sword']],
			...
			["Thieves' Town - Boss", true, ['KeyD4', 'MoonPearl', 'DefeatAgahnim', 'Flippers', 'Hookshot', 'BigKeyD4', 'L1Sword']],
