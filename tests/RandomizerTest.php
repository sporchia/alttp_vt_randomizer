...
class RandomizerTest extends TestCase {
	...
	public function testLogicHasntChangedNoMajorGlitches() {
		...
		$this->assertEquals([
			...
			"[cave-012-1F] Death Mountain - wall of caves - left cave" => "OneRupee",
			"[cave-013] Mimic cave (from Turtle Rock)" => "CaneOfByrna",
			"[cave-009-1F] Death Mountain - wall of caves - right cave [top left chest]" => "Boomerang",
			"[cave-009-1F] Death Mountain - wall of caves - right cave [top left middle chest]" => "BottleWithGoldBee",
			...
			"[cave-009-B1] Death Mountain - wall of caves - right cave [right chest]" => "PegasusBoots",
			"Piece of Heart (Death Mountain - floating island)" => "BugCatchingNet",
	...
	public function testLogicHasntChangedGlitched() {
		...
		$this->assertEquals([
			...
			"[cave-009-1F] Death Mountain - wall of caves - right cave [bottom chest]" => "Lamp",
			"[cave-009-B1] Death Mountain - wall of caves - right cave [left chest]" => "TwentyRupees",
			"[cave-009-B1] Death Mountain - wall of caves - right cave [right chest]" => "FireRod",
			"Piece of Heart (Death Mountain - floating island)" => "ProgressiveGlove",
			"Ether Tablet" => "CaneOfByrna",
			"Piece of Heart (Spectacle Rock)" => "TwentyRupees",
