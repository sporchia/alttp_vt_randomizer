...
class RandomizerTest extends TestCase {
	...
	public function testLogicHasntChangedGlitched() {
		...
		$this->assertEquals([
			...
			"[cave-035] Sahasrahla's Hut [left chest]" => "OneRupee",
			"[cave-035] Sahasrahla's Hut [center chest]" => "BlueShield",
			"[cave-035] Sahasrahla's Hut [right chest]" => "HeartContainer",
			"[cave-021] Kakariko well [top chest]" => "ArrowUpgrade5",
			"[cave-021] Kakariko well [left chest row of 3]" => "PieceOfHeart",
			"[cave-021] Kakariko well [center chest row of 3]" => "PieceOfHeart",
			"[cave-021] Kakariko well [right chest row of 3]" => "MirrorShield",
			"[cave-021] Kakariko well [bottom chest]" => "PieceOfHeart",
			...
			"[cave-022-B1] Thief's hut [bottom right chest]" => "Arrow",
			"[cave-016] cave under rocks west of Santuary" => "MoonPearl",
			...
			"[cave-050] cave southwest of Lake Hylia [bottom right chest]" => "BottleWithRedPotion",
			"[cave-051] Ice Cave" => "TwentyRupees",
			"Bottle Vendor" => "BottleWithBluePotion",
			"Sahasrahla" => "PieceOfHeart",
			...
			"[cave-050] cave southwest of Lake Hylia - generous guy" => "Cape",
			"Library" => "ArrowUpgrade10",
			"Mushroom" => "FiftyRupees",
			"Witch" => "TwentyRupees",
			...
			"Piece of Heart (Zora's River)" => "Shovel",
			"Haunted Grove item" => "Hammer",
			...
			"[cave-012-1F] Death Mountain - wall of caves - left cave" => "BottleWithFairy",
			"[cave-013] Mimic cave (from Turtle Rock)" => "FiftyRupees",
			...
			"[cave-009-1F] Death Mountain - wall of caves - right cave [top right middle chest]" => "TwentyRupees",
			"[cave-009-1F] Death Mountain - wall of caves - right cave [top right chest]" => "CaneOfSomaria",
			...
			"[dungeon-L3-1F] Tower of Hera - freestanding key" => "Key",
			"[dungeon-L3-2F] Tower of Hera - Entrance" => "RedMail",
			...
			"[cave-071] Misery Mire west area [left chest]" => "PieceOfHeart",
			"[cave-071] Misery Mire west area [right chest]" => "ThreeBombs",
			...
			"[cave-056] Dark World Death Mountain - cave under boulder [top right chest]" => "Bottle",
			"[cave-056] Dark World Death Mountain - cave under boulder [top left chest]" => "OcarinaInactive",
			"[cave-056] Dark World Death Mountain - cave under boulder [bottom left chest]" => "Lamp",
			"[cave-056] Dark World Death Mountain - cave under boulder [bottom right chest]" => "PieceOfHeart",
			"Catfish" => "Flippers",
			"Piece of Heart (Pyramid)" => "Mushroom",
			...
			"[cave-073] cave northeast of swamp palace [bottom chest]" => "BombUpgrade5",
			"Flute Boy" => "PieceOfHeart",
			"[cave-073] cave northeast of swamp palace - generous guy" => "ThreeBombs",
			"Piece of Heart (Digging Game)" => "Bow",
			"[dungeon-D1-1F] Dark Palace - big key room" => "TwentyRupees",
			"[dungeon-D1-1F] Dark Palace - jump room [right chest]" => "Key",
			"[dungeon-D1-1F] Dark Palace - jump room [left chest]" => "RedBoomerang",
			"[dungeon-D1-1F] Dark Palace - big chest" => "Key",
			...
			"Heart Container - Helmasaur King" => "IceRod",
			...
			"[dungeon-D2-B2] Swamp Palace - hidden waterfall door room" => "OneRupee",
			"Heart Container - Arrghus" => "ThreeHundredRupees",
			"[dungeon-D3-B1] Skull Woods - big chest" => "Compass",
			"[dungeon-D3-B1] Skull Woods - Big Key room" => "BombUpgrade5",
			"[dungeon-D3-B1] Skull Woods - Compass room" => "Key",
			"[dungeon-D3-B1] Skull Woods - east of Fire Rod room" => "Powder",
			...
			"[dungeon-D4-B1] Thieves' Town - Bottom left of huge room [bottom right chest]" => "Compass",
			"[dungeon-D4-B1] Thieves' Town - Bottom left of huge room [top left chest]" => "Boomerang",
			...
			"[dungeon-D5-B1] Ice Palace - Big Key room" => "ThreeBombs",
			"[dungeon-D5-B1] Ice Palace - compass room" => "Key",
			"[dungeon-D5-B2] Ice Palace - map room" => "Compass",
			"[dungeon-D5-B3] Ice Palace - spike room" => "Map",
			"[dungeon-D5-B4] Ice Palace - above Blue Mail room" => "Key",
			"[dungeon-D5-B5] Ice Palace - b5 up staircase" => "Ether",
			"[dungeon-D5-B5] Ice Palace - big chest" => "FireRod",
			"Heart Container - Kholdstare" => "BigKey",
			"[dungeon-D6-B1] Misery Mire - big chest" => "ArrowUpgrade5",
			"[dungeon-D6-B1] Misery Mire - big hub room" => "BigKey",
			"[dungeon-D6-B1] Misery Mire - big key" => "Compass",
			"[dungeon-D6-B1] Misery Mire - compass" => "BossHeartContainer",
			"[dungeon-D6-B1] Misery Mire - end of bridge" => "Key",
			"[dungeon-D6-B1] Misery Mire - map room" => "Key",
			...
			"[dungeon-D7-B2] Turtle Rock - Eye bridge room [top right chest]" => "RedShield",
			"Heart Container - Trinexx" => "TwentyRupees",
			"[dungeon-A2-1F] Ganon's Tower - down left staircase from entrance" => "BossHeartContainer",
			...
			"[dungeon-A2-1F] Ganon's Tower - west of teleport room [bottom right chest]" => "BombUpgrade10",
			"[dungeon-A2-1F] Ganon's Tower - north of teleport room" => "Key",
			"[dungeon-A2-1F] Ganon's Tower - map room" => "TwentyRupees",
			...
			"[dungeon-A2-1F] Ganon's Tower - above Armos" => "Bombos",
			"[dungeon-A2-1F] Ganon's Tower - east of down right staircase from entrace" => "Key",
			...
			"[dungeon-A2-6F] Ganon's Tower - Moldorm room" => "PowerGlove",
			"Eastern Palace Pendant" => "PendantOfWisdom",
			"Desert Palace Pendant" => "Crystal7",
			"Tower of Hera Pendant" => "Crystal1",
			"Palace of Darkness Crystal" => "Crystal3",
