...
class RandomizerTest extends TestCase {
	...
	public function testLogicHasntChangedNoMajorGlitches() {
		...
		$this->assertEquals([
			...
			"Piece of Heart (Lumberjack Tree)" => "ProgressiveGlove",
			...
			"[dungeon-C-B1] Escape - first B1 room" => "ProgressiveGlove",
			...
			"Piece of Heart (Spectacle Rock Cave)" => "OneRupee",
			...
			"[cave-009-B1] Death Mountain - wall of caves - right cave [right chest]" => "BottleWithBluePotion",
			...
			"[cave-055] Spike cave" => "ThreeBombs",
			"[cave-071] Misery Mire west area [left chest]" => "Bottle",
			"[cave-071] Misery Mire west area [right chest]" => "Shovel",
			...
			"Piece of Heart (Treasure Chest Game)" => "RedBoomerang",
			"Piece of Heart (Dark World blacksmith pegs)" => "ThreeBombs",
			"Piece of Heart (Dark World - bumper cave)" => "PieceOfHeart",
			"[cave-073] cave northeast of swamp palace [top chest]" => "Hookshot",
			"[cave-073] cave northeast of swamp palace [top middle chest]" => "Flippers",
			...
			"[dungeon-D5-B1] Ice Palace - Big Key room" => "FireRod",
	...
	public function testLogicHasntChangedGlitched() {
		...
		$this->assertEquals([
			...
			"[cave-071] Misery Mire west area [right chest]" => "ProgressiveArmor",
			...
			"[cave-056] Dark World Death Mountain - cave under boulder [top right chest]" => "OneRupee",
			...
			"Ganon" => "DefeatGanon",
			"Catfish" => "FiveRupees",
			"Piece of Heart (Pyramid)" => "ArrowUpgrade5",
			"Pyramid - Sword" => "L1Sword",
			"Pyramid - Bow" => "BowAndArrows",
			"Pyramid Fairy - Left" => "BossHeartContainer",
			"Pyramid Fairy - Right" => "ArrowUpgrade10",
			"[cave-063] doorless hut" => "CaneOfSomaria",
			...
			"[cave-073] cave northeast of swamp palace [bottom chest]" => "BottleWithGreenPotion",
			"Flute Boy" => "BottleWithBee",
			"[cave-073] cave northeast of swamp palace - generous guy" => "ArrowUpgrade5",
			"Piece of Heart (Digging Game)" => "HalfMagic",
