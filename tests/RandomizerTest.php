...
class RandomizerTest extends TestCase {
	...
	public function testLogicHasntChanged() {
		...
		$this->assertEquals([
			...
			"[cave-050] cave southwest of Lake Hylia [bottom left chest]" => "OneRupee",
			...
			"Piece of Heart (Desert - west side)" => "OneHundredRupees",
			...
			"[cave-057-1F] Dark World Death Mountain - cave from top to bottom [top chest]" => "OneHundredRupees",
			...
			"[cave-056] Dark World Death Mountain - cave under boulder [bottom left chest]" => "OneHundredRupees",
			...
			"Piece of Heart (Dark World - bumper cave)" => "TenArrows",
			...
			"Heart Container - Arrghus" => "FiftyRupees",
			...
			"[dungeon-D4-B2] Thieves' Town - next to Blind" => "ThreeBombs",
			...
			"[dungeon-D5-B5] Ice Palace - big chest" => "FiftyRupees",
			...
			"[dungeon-A2-B1] Ganon's Tower - north of Armos room [right chest]" => "OneRupee",
