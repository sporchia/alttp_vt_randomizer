<template>
	<div class="card border-success">
		...
		<div class="card-body">
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['prize.crossWorld']" :selected="true" storage-key="vt.custom.prize.crossWorld">
				...
				<div class="col">
					<vt-toggle v-model="context['prize.shufflePendants']" :selected="true" storage-key="vt.custom.prize.shufflePendants">
						Shuffle Pendants
			...
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['prize.shuffleCrystals']" :selected="true" storage-key="vt.custom.prize.shuffleCrystals">
						Shuffle Crystals
						<template slot="tooltip">If No, crystals are as they are in the vanilla game. If Yes, crystals are shuffled.</template>
					</vt-toggle>
				</div>
				<div class="col">
					<vt-toggle v-model="context['region.bossNormalLocation']" :selected="true" storage-key="vt.custom.region.bossNormalLocation">
			...
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['spoil.BootsLocation']" :selected="false" storage-key="vt.custom.spoil.BootsLocation">
				...
				<div class="col">
					<vt-toggle v-model="context['sprite.shuffleOverworldBonkPrizes']" :selected="false" storage-key="vt.custom.sprite.shuffleOverworldBonkPrizes">
			...
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['rom.mapOnPickup']" :selected="false" storage-key="vt.custom.rom.mapOnPickup">
				...
				<div class="col">
					<vt-toggle v-model="context['rom.compassOnPickup']" :selected="false" storage-key="vt.custom.rom.compassOnPickup">
			...
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['item.require.Lamp']" :selected="false" storage-key="vt.custom.item.require.Lamp">
				...
				<div class="col">
					<vt-toggle v-model="context['rom.freeItemText']" :selected="false" storage-key="vt.custom.rom.freeItemText">
			...
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['rom.freeItemMenu']" :selected="false" storage-key="vt.custom.rom.freeItemMenu">
				...
				<div class="col">
					<vt-toggle v-model="context['region.wildCompasses']" :selected="false" storage-key="vt.custom.region.wildCompasses">
			...
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['region.wildMaps']" :selected="false" storage-key="vt.custom.region.wildMaps">
				...
				<div class="col">
					<vt-toggle v-model="context['region.wildKeys']" :selected="false" storage-key="vt.custom.region.wildKeys">
			...
			<div class="row mb-3">
				<div class="col">
					<vt-toggle v-model="context['region.wildBigKeys']" :selected="false" storage-key="vt.custom.region.wildBigKeys">
			...
			<div class="row mb-3">
				<div class="col">
					<vt-text v-model="context['item.Goal.Required']" type="number" placeholder="pieces" maxlength="9" storage-key="vt.custom.item.Goal.Required">
						Goal Items
						<template slot="tooltip">Only applies to Triforce Hunt. The number of triforce pieces required to complete the game.</template>
					</vt-text>
				</div>
				<div class="col">
					<vt-select :value="context['rom.timerMode']" @input="context['rom.timerMode'] = $event.value" :options="settings.timers" storage-key="vt.custom.rom.timerMode" :default="choice.timer">
						Timer
			...
			<div class="row mb-3">
				<div class="col">
					<vt-text v-model="context['rom.timerStart']" type="number" placeholder="seconds" maxlength="9" storage-key="vt.custom.rom.timerStart">
						Timer Start
						<template slot="tooltip">The starting value of the timer in seconds.</template>
					</vt-text>
				</div>
				<div class="col">
					<vt-text v-model="context['item.value.GreenClock']" type="number" placeholder="seconds" maxlength="9" storage-key="vt.custom.item.value.GreenClock">
						Green Clock
			...
			<div class="row mb-3">
				<div class="col">
					<vt-text v-model="context['item.value.BlueClock']" type="number" placeholder="seconds" maxlength="9" storage-key="vt.custom.item.value.BlueClock">
						Blue Clock
				...
				<div class="col">
					<vt-text v-model="context['item.value.RedClock']" type="number" placeholder="seconds" maxlength="9" storage-key="vt.custom.item.value.RedClock">
						Red Clock
			...
			<div class="row mb-3">
				<div class="col">
					<vt-text v-model="context['item.value.Rupoor']"  type="number" placeholder="rupees to take away" maxlength="9" storage-key="vt.custom.item.value.Rupoor">
						Rupoor Value
