...
export default {
  ...
  actions: {
    ...
    initalize({ commit, dispatch, state, rootGetters }) {
    ...
    setLocation({ commit, getters, rootGetters }, data) {
      data = {
        save: true,
    ...
    setItemCount({ commit, getters }, data) {
      data = {
        save: true,
        ...data
      };
  ...
  mutations: {
    setLocation(state, data) {
      ...
      if (Object.prototype.hasOwnProperty.call(previous, "count")) {
      ...
      if (Object.prototype.hasOwnProperty.call(data.item, "count")) {
        if (data.item.count > 0) {
          data.item.count--;
        } else {
          data.item.neg_count = data.item.neg_count
            ? data.item.neg_count - 1
            : -1;
        }
      }
    },
