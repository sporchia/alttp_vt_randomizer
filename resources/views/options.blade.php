...
<div class="panel panel-info">
	...
	<div class="panel-body">
		...
		<tbody><tr class="table-primary">
			...
			<td>2</td>
			<td>1</td>
			<td>1<span class="glyphicon glyphicon-info-sign options-tooltip" data-toggle="tooltip" title="Silver Arrows only function in Ganon's room."></span></td>
			<td>1<span class="glyphicon glyphicon-info-sign options-tooltip" data-toggle="tooltip" title="Silver Arrows only function in Ganon's room."></span></td>
			<td>0</td>
		</tr><tr class="table-secondary">
			...
			<td># of Bottles</td>
			<td>8<span class="glyphicon glyphicon-info-sign options-tooltip" data-toggle="tooltip" title="Once 4 Bottles have been collected, the remaining Bottles will revert to rupees."></span></td>
			<td>4</td>
			<td>4</td>
			<td>4</td>
			<td>4</td>
			...
			<td>Potion Magic Refill<span class="glyphicon glyphicon-info-sign options-tooltip" data-toggle="tooltip" title="Potions will fill 100% magic in Spike Cave."></span></td>
			<td>100%</td>
			<td>100%</td>
			<td>50%</td>
			<td>25%</td>
			...
			<td>Potion Hearts Refill<span class="glyphicon glyphicon-info-sign options-tooltip" data-toggle="tooltip" title="Potions will fill 20 hearts in Spike Cave."></span></td>
			<td>20</td>
			<td>20</td>
			<td>7</td>
			<td>1</td>
...
<div class="panel panel-info">
	...
	<div class="panel-body">
		...
		<p>One random single-entrace cave will contain a mysterious yer familiar old man with a sword
			 upgrade. This sword upgrade takes the place of one in the item pool.</p>
	</div>
</div>

<script>$('.options-tooltip').tooltip();</script>
