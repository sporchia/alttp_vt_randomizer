...
<div class="well">
	<p>There are a few changes from the original game which enhance gameplay and prevent you getting
		stuck. The Japanese 1.0 version is used as a base ROM because it allows use of some exclusive
		glitches in some of the advanced game modes. You may see some Japanese text but this will
		eventually all be removed.</p>
	<ul>
		<li>You no longer need the Lamp to push the bookshelf during the prologue and you can now see
			in dark rooms in the Sewers even without the Lamp (except in Open mode).</li>
		...
		<li>The water levels within Swamp Palace will revert to being drained when you exit the
			overworld screen. This prevents you accidentally drowning keys underwater and getting
			stuck.</li>
		<li>The file select screen has a random row of symbols at the top. These are a unique
			identifier for each seed generated and do not have any other relevance.</li>
