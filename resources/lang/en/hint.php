...
return [
	"item" => [
		...
		"UncleSword" => "A weapon",
		"L1Sword" => "A weapon",
		"L1SwordAndShield" => "A weapon",
		"L2Sword" => "A weapon",
		"MasterSword" => "A weapon",
		"L3Sword" => "A weapon",
		"L4Sword" => "A weapon",
		"BlueShield" => "A Shield",
		"RedShield" => "A Shield",
		...
		"BlueClock" => "A Clock",
		"GreenClock" => "A Clock",
		"ProgressiveSword" => "A Sword",
		"ProgressiveShield" => "A Shield",
		"ProgressiveArmor" => "Armor",
		"ProgressiveGlove" => "A Glove",
		"singleRNG" => "Something",
		"multiRNG" => "Something",
	...
	"location" => [
		...
		"Blind's Hideout - Top" => "is in Blind's Hideout",
		...
		"Castle Tower - Dark Maze" => "is in Castle Tower",
		...
		"Desert Palace - Torch" => "is in Desert Palace",
		...
		"Floating Island" => "is on Floating Island",
		...
		"Ganon's Tower - Bob's Torch" => ["is in Ganon's Tower", "requires the boots"],
		...
		"Ganon's Tower - Tile Room" => "is in Ganon's Tower",
		...
		"Kakariko Well - Top" => "is in Kakariko Well",
		...
		"Lumberjack Tree" => ["is in plain sight", "requires a bomb"],
		...
		"Purple Chest" => "is hiding in a chest unlocked elsewhere",
		...
		"Sahasrahla's Hut - Left" => ["is in a sages closet", "requires a bomb"],
		"Sahasrahla's Hut - Middle" => ["is in a sages closet", "requires a bomb"],
		"Sahasrahla's Hut - Right" => ["is in a sages closet", "requires a bomb"],
		"Sanctuary" => "is in the Sanctuary",
		"Secret Passage" => "is near your Uncle",
		"Sewers - Dark Cross" => ["is in the Sewers", "is in the dark"],
		"Sewers - Secret Room - Left" => ["is in the Sewers", "requires a bomb"],
		"Sewers - Secret Room - Middle" => ["is in the Sewers", "requires a bomb"],
		"Sewers - Secret Room - Right" => ["is in the Sewers", "requires a bomb"],
		...
		"Spectacle Rock Cave" => "is in Spectacle Rock",
		"Spectacle Rock" => "is on Spectacle Rock",
		...
		"Swamp Palace - Flooded Room - Left" => ["is in Swamp Palace", "requires the hookshot", "requires the Hammer"],
		"Swamp Palace - Flooded Room - Right" => ["is in Swamp Palace", "requires the hookshot", "requires the Hammer"],
		"Swamp Palace - Map Chest" => ["is in Swamp Palace", "requires the Hammer"],
		...
		"Tower of Hera - Basement Cage" => "is in Tower of Hera",
		...
		"Turtle Rock - Compass Chest" => "is in Turtle Rock",
		...
		"Turtle Rock - Roller Room - Left" => "is in Turtle Rock",
		"Turtle Rock - Roller Room - Right" => "is in Turtle Rock",
