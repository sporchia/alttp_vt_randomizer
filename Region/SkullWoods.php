...
class SkullWoods extends Region {
	...
	public function __construct(World $world) {
		...
		$this->locations = new LocationCollection([
			new Location("[dungeon-D3-B1] Skull Woods - big chest", 0xE998, $this),
			new Location("[dungeon-D3-B1] Skull Woods - Big Key room", 0xE99E, $this),
			new Location("[dungeon-D3-B1] Skull Woods - Compass room", 0xE992, $this),
			new Location("[dungeon-D3-B1] Skull Woods - east of Fire Rod room", 0xE99B, $this),
			new Location("[dungeon-D3-B1] Skull Woods - Entrance to part 2", 0xE9FE, $this),
			new Location("[dungeon-D3-B1] Skull Woods - Gibdo/Stalfos room", 0xE9A1, $this),
			new Location("[dungeon-D3-B1] Skull Woods - south of Fire Rod room", 0xE9C8, $this),
			new Location("Heart Container - Mothula", 0x180155, $this),
		]);
	}
