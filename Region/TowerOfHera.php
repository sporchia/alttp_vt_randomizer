...
class TowerOfHera extends Region {
	...
	public function __construct(World $world) {
		...
		$this->locations = new LocationCollection([
			new Location("[dungeon-L3-1F] Tower of Hera - first floor", 0xE9E6, $this),
			new Location("[dungeon-L3-2F] Tower of Hera - Entrance", 0xE9AD, $this),
			new Location("[dungeon-L3-4F] Tower of Hera - 4F [small chest]", 0xE9FB, $this),
			new Location("[dungeon-L3-4F] Tower of Hera - big chest", 0xE9F8, $this),
			new Location("Heart Container - Moldorm", 0x180152, $this),
		]);
	}
