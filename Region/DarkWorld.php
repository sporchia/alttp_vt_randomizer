...
class DarkWorld extends Region {
	...
	public function __construct(World $world) {
		...
		$this->locations = new LocationCollection([
			new Location("[cave-055] Spike cave", 0xEA8B, null, $this),
			new Location("[cave-063] doorless hut", 0xE9EC, null, $this),
			new Location("[cave-062] C-shaped house", 0xE9EF, null, $this),
			new Location("[cave-071] Misery Mire west area [left chest]", 0xEA73, null, $this),
			new Location("[cave-071] Misery Mire west area [right chest]", 0xEA76, null, $this),
			new Location("[cave-057-1F] Dark World Death Mountain - cave from top to bottom [top chest]", 0xEA7C, null, $this),
			new Location("[cave-057-1F] Dark World Death Mountain - cave from top to bottom [bottom chest]", 0xEA7F, null, $this),
			new Location("[cave-073] cave northeast of swamp palace [top chest]", 0xEB1E, null, $this),
			new Location("[cave-073] cave northeast of swamp palace [top middle chest]", 0xEB21, null, $this),
			new Location("[cave-073] cave northeast of swamp palace [bottom middle chest]", 0xEB24, null, $this),
			new Location("[cave-073] cave northeast of swamp palace [bottom chest]", 0xEB27, null, $this),
			new Location("[cave-056] Dark World Death Mountain - cave under boulder [top right chest]", 0xEB51, null, $this),
			new Location("[cave-056] Dark World Death Mountain - cave under boulder [top left chest]", 0xEB54, null, $this),
			new Location("[cave-056] Dark World Death Mountain - cave under boulder [bottom left chest]", 0xEB57, null, $this),
			new Location("[cave-056] Dark World Death Mountain - cave under boulder [bottom right chest]", 0xEB5A, null, $this),
			new Location("Piece of Heart (Treasure Chest Game)", 0xEDA8, null, $this),
			new Location("Flute Boy", 0x330C7, null, $this),
			new Location("Catfish", 0xEE185, null, $this),
			new Location("Piece of Heart (Dark World blacksmith pegs)", 0x180006, null, $this),
			new Location("[cave-073] cave northeast of swamp palace - generous guy", 0x180011, null, $this),
			new Location("Piece of Heart (Dark World - bumper cave)", 0x180146, null, $this),
			new Location("Piece of Heart (Pyramid)", 0x180147, null, $this),
			new Location("Piece of Heart (Digging Game)", 0x180148, null, $this),
		]);
	}
