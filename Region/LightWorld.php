...
class LightWorld extends Region {
	...
	public function __construct(World $world) {
		...
		$this->locations = new LocationCollection([
			...
			new Location("[cave-018] Graveyard - top right grave", 0xE97A, null, $this),
			new Location("[cave-047] Dam", 0xE98C, null, $this),
			new Location\Chest("[cave-040] Link's House", 0xE9BC, null, $this),
			new Location("[cave-031] Tavern", 0xE9CE, null, $this),
			new Location("[cave-026] chicken house", 0xE9E9, null, $this),
			new Location("[cave-044] Aginah's cave", 0xE9F2, null, $this),
			new Location("[cave-035] Sahasrahla's Hut [left chest]", 0xEA82, null, $this),
			new Location("[cave-035] Sahasrahla's Hut [center chest]", 0xEA85, null, $this),
			new Location("[cave-035] Sahasrahla's Hut [right chest]", 0xEA88, null, $this),
			new Location("[cave-021] Kakariko well [top chest]", 0xEA8E, null, $this),
			new Location("[cave-021] Kakariko well [left chest row of 3]", 0xEA91, null, $this),
			new Location("[cave-021] Kakariko well [center chest row of 3]", 0xEA94, null, $this),
			new Location("[cave-021] Kakariko well [right chest row of 3]", 0xEA97, null, $this),
			new Location("[cave-021] Kakariko well [bottom chest]", 0xEA9A, null, $this),
			new Location("[cave-022-B1] Thief's hut [top chest]", 0xEB0F, null, $this),
			new Location("[cave-022-B1] Thief's hut [top left chest]", 0xEB12, null, $this),
			new Location("[cave-022-B1] Thief's hut [top right chest]", 0xEB15, null, $this),
			new Location("[cave-022-B1] Thief's hut [bottom left chest]", 0xEB18, null, $this),
			new Location("[cave-022-B1] Thief's hut [bottom right chest]", 0xEB1B, null, $this),
			new Location("[cave-016] cave under rocks west of Santuary", 0xEB3F, null, $this),
			new Location("[cave-050] cave southwest of Lake Hylia [bottom left chest]", 0xEB42, null, $this),
			new Location("[cave-050] cave southwest of Lake Hylia [top left chest]", 0xEB45, null, $this),
			new Location("[cave-050] cave southwest of Lake Hylia [top right chest]", 0xEB48, null, $this),
			new Location("[cave-050] cave southwest of Lake Hylia [bottom right chest]", 0xEB4B, null, $this),
			new Location("[cave-051] Ice Cave", 0xEB4E, null, $this),
			...
			new Location("Piece of Heart (Thieves' Forest Hideout)", 0x180000, null, $this),
			new Location("Piece of Heart (Lumberjack Tree)", 0x180001, null, $this),
			new Location("Piece of Heart (south of Haunted Grove)", 0x180003, null, $this),
			new Location("Piece of Heart (Graveyard)", 0x180004, null, $this),
			new Location("Piece of Heart (Desert - northeast corner)", 0x180005, null, $this),
			new Location("[cave-050] cave southwest of Lake Hylia - generous guy", 0x180010, null, $this),
			new Location\Dash("Library", 0x180012, null, $this),
			new Location("Mushroom", 0x180013, null, $this),
			new Location\Npc("Witch", 0x180014, null, $this),
			new Location("Piece of Heart (Maze Race)", 0x180142, null, $this),
			new Location("Piece of Heart (Desert - west side)", 0x180143, null, $this),
			new Location("Piece of Heart (Lake Hylia)", 0x180144, null, $this),
			new Location("Piece of Heart (Dam)", 0x180145, null, $this),
			new Location("Piece of Heart (Zora's River)", 0x180149, null, $this),
			new Location("Haunted Grove item", 0x18014A, null, $this),
		]);
	}
