...
Route::any('entrance/seed/{seed_id?}', function(Request $request, $seed_id = null) {
	...
	try {
		$rand = new ALttP\EntranceRandomizer($difficulty, 'noglitches', $request->input('goal', 'ganon'), $variation, $request->input('shuffle', 'full'), $request->input('ganon_shuffle') == 'true');
