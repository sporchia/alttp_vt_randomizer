...
class Item {
	...
	static public function all() {
		...
		static::$items = new ItemCollection([
			...
			new Item\Egg('Egg0', 'Egg', [0xB0]),
			new Item\Egg('Egg1', 'Egg', [0xB1]),
			new Item\Egg('Egg2', 'Egg', [0xB2]),
			new Item\Egg('Egg3', 'Egg', [0xB3]),
			new Item\Egg('Egg4', 'Egg', [0xB4]),
			new Item\Egg('Egg5', 'Egg', [0xB5]),
			new Item\Egg('Egg6', 'Egg', [0xB6]),
			new Item\Egg('Egg7', 'Egg', [0xB7]),
			new Item\Egg('Egg8', 'Egg', [0xB8]),
			new Item\Egg('Egg9', 'Egg', [0xB9]),
			new Item\Egg('EggA', 'Egg', [0xBA]),
			new Item\Egg('EggB', 'Egg', [0xBB]),
			new Item\Egg('EggC', 'Egg', [0xBC]),
			new Item\Egg('EggD', 'Egg', [0xBD]),
			new Item\Egg('EggE', 'Egg', [0xBE]),
			new Item\Egg('EggF', 'Egg', [0xBF]),
