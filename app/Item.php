...
class Item {
	...
	static public function all() {
		...
		static::$items = new ItemCollection([
			...
			new Item\Pendant('PendantOfCourage', 'Pendant Of Courage', [0x37, 0x04, 0x04, 0x38, 0x60, 0x00, 0x69, 0x01]),
			new Item\Pendant('PendantOfWisdom', 'Pendant Of Wisdom', [0x38, 0x01, 0x01, 0x32, 0x60, 0x00, 0x69, 0x03]),
			new Item\Pendant('PendantOfPower', 'Pendant Of Power', [0x39, 0x02, 0x02, 0x34, 0x60, 0x00, 0x69, 0x02]),
			...
			new Item\Crystal('Crystal1', 'Crystal 1', [null, 0x02, 0x02, 0x34, 0x64, 0x40, 0x7F, 0x06], [0x10860]),
			new Item\Crystal('Crystal2', 'Crystal 2', [null, 0x10, 0x10, 0x34, 0x64, 0x40, 0x79, 0x06], [0x1085E]),
			new Item\Crystal('Crystal3', 'Crystal 3', [null, 0x40, 0x40, 0x34, 0x64, 0x40, 0x6C, 0x06], [0x10862]),
			new Item\Crystal('Crystal4', 'Crystal 4', [null, 0x20, 0x20, 0x34, 0x64, 0x40, 0x6D, 0x06], [0x1086A]),
			new Item\Crystal('Crystal5', 'Crystal 5', [null, 0x04, 0x04, 0x34, 0x64, 0x40, 0x6E, 0x06], [0x10866]),
			new Item\Crystal('Crystal6', 'Crystal 6', [null, 0x01, 0x01, 0x34, 0x64, 0x40, 0x6F, 0x06], [0x10864]),
			new Item\Crystal('Crystal7', 'Crystal 7', [null, 0x08, 0x08, 0x34, 0x64, 0x40, 0x7C, 0x06], [0x10868]),
		]);
		return static::all();
	}
