...
class Sprite {
	...
	static public function all() {
		...
		static::$items = new SpriteCollection([
			...
			new Sprite\Droppable("Heart", "Heart", [0xD8]),
			new Sprite\Droppable("RupeeGreen", "Green Rupee", [0xD9]),
			new Sprite\Droppable("RupeeBlue", "Blue Rupee", [0xDA]),
			new Sprite\Droppable("RupeeRed", "Red Rupee", [0xDB]),
			new Sprite\Droppable("BombRefill1", "Bomb Refill (1)", [0xDC]),
			new Sprite\Droppable("BombRefill4", "Bomb Refill (4)", [0xDD]),
			new Sprite\Droppable("BombRefill8", "Bomb Refill (8)", [0xDE]),
			new Sprite\Droppable("MagicRefillSmall", "Small Magic Refill", [0xDF]),
			new Sprite\Droppable("MagicRefillFull", "Full Magic Refill", [0xE0]),
			new Sprite\Droppable("ArrowRefill5", "Arrow Refill (5)", [0xE1]),
			new Sprite\Droppable("ArrowRefill10", "Arrow Refill (10)", [0xE2]),
			new Sprite\Droppable("Fairy", "Fairy", [0xE3]),
