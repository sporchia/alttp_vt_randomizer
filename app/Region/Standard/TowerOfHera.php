...
class TowerOfHera extends Region {
	...
	public function setVanilla() {
		...
		$this->locations["Tower of Hera - Boss"]->setItem(Item::get('BossHeartContainer'));
	...
	public function initNoGlitches() {
		...
		$this->locations["Tower of Hera - Boss"]->setRequirements(function($locations, $items) {
			return $this->canEnter($locations, $items)
				...
				&& $items->has('BigKeyP3')
				&& (!$this->world->config('region.wildCompasses', false) || $items->has('CompassP3') || $this->locations["Tower of Hera - Boss"]->hasItem(Item::get('CompassP3')))
				&& (!$this->world->config('region.wildMaps', false) || $items->has('MapP3') || $this->locations["Tower of Hera - Boss"]->hasItem(Item::get('MapP3')));
