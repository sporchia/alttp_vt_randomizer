...
class ThievesTown extends Region {
	...
	public function setVanilla() {
		...
		$this->locations["Thieves' Town - Boss"]->setItem(Item::get('BossHeartContainer'));
	...
	public function initNoGlitches() {
		...
		$this->locations["Thieves' Town - Boss"]->setRequirements(function($locations, $items) {
			return $this->canEnter($locations, $items)
				...
				&& (!$this->world->config('region.wildCompasses', false) || $items->has('CompassD4') || $this->locations["Thieves' Town - Boss"]->hasItem(Item::get('CompassD4')))
				&& (!$this->world->config('region.wildMaps', false) || $items->has('MapD4') || $this->locations["Thieves' Town - Boss"]->hasItem(Item::get('MapD4')));
