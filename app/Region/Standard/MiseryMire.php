...
class MiseryMire extends Region {
	...
	public function setVanilla() {
		...
		$this->locations["Misery Mire - Boss"]->setItem(Item::get('BossHeartContainer'));
	...
	public function initNoGlitches() {
		...
		$this->locations["Misery Mire - Boss"]->setRequirements(function($locations, $items) {
			return $this->canEnter($locations, $items)
				...
				&& (!$this->world->config('region.wildCompasses', false) || $items->has('CompassD6') || $this->locations["Misery Mire - Boss"]->hasItem(Item::get('CompassD6')))
				&& (!$this->world->config('region.wildMaps', false) || $items->has('MapD6') || $this->locations["Misery Mire - Boss"]->hasItem(Item::get('MapD6')));
	...
	public function initMajorGlitches() {
		...
		$this->can_complete = function($locations, $items) {
			return ($this->canEnter($locations, $items)
				...
				|| $items->has('KeyD6', 3))
				&& ($locations["Tower of Hera - Boss"]->canAccess($items)
