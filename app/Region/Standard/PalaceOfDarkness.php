...
class PalaceOfDarkness extends Region {
	...
	public function setVanilla() {
		...
		$this->locations["Palace of Darkness - Boss"]->setItem(Item::get('BossHeartContainer'));
	...
	public function initNoGlitches() {
		...
		$this->locations["Palace of Darkness - Boss"]->setRequirements(function($locations, $items) {
			return $this->canEnter($locations, $items)
				...
				&& (!$this->world->config('region.wildCompasses', false) || $items->has('CompassD1') || $this->locations["Palace of Darkness - Boss"]->hasItem(Item::get('CompassD1')))
				&& (!$this->world->config('region.wildMaps', false) || $items->has('MapD1') || $this->locations["Palace of Darkness - Boss"]->hasItem(Item::get('MapD1')));
